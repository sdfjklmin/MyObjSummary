...
//核心思路:
//  划分责任    =>  通过责任划分，将单一功能抽象成类
//  抽离接口    =>  一些公用组件应该基于接口编程(日志[File|Db|Redis|...]、消息[MQ|Middle]、短信[腾讯|阿里]、邮件[Email|QQMail|GMail]等)
//  确定依赖    =>  确定责任之间的依赖，A是否依赖于B，如果是尽可能地通过 依赖注入、服务容器、依赖接口 来实现
//  服务容器    =>  区局性的功能业务，可以抽离到服务容器中进行公有化
